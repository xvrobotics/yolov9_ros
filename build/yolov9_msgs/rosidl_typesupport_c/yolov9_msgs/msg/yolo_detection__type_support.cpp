...
static const _YoloDetection_type_support_symbol_names_t _YoloDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolov9_msgs, msg, YoloDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolov9_msgs, msg, YoloDetection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolov9_msgs, msg, YoloDetection)() {
  return &::yolov9_msgs::msg::rosidl_typesupport_c::YoloDetection_message_type_support_handle;
}
